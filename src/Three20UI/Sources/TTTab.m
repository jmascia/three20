...
/**
 *  Fixes bug where badge gets positioned to the left of the Tab because the tab hasn't been laid
 *  out yet. (from Itay Neeman)
 *  http://groups.google.com/group/three20/browse_thread/thread/fafd4cd606fcd4a1
 */
